...
public class SalesView extends View {
    ...
    private final TableColumn<Bill, String> isbnCol = new TableColumn<>("ISBN");
    private final TableColumn<Bill, String> titleCol = new TableColumn<>("Title");
    private final TableColumn<Bill, Float> sellingPriceCol = new TableColumn<>("Selling Price");
    private final TableColumn<Bill, Integer> quantityCol = new TableColumn<>("Quantity");
    private final TableColumn<Bill, String> authorCol = new TableColumn<>("Author");
    private final TableColumn<Bill, Integer> totalAmountCol = new TableColumn<>("TotalAmount");
    private final TableColumn<Bill, String> userCol = new TableColumn<>("User");
